...
var OpAttributeSanitizer = (function () {
    ...
    OpAttributeSanitizer.sanitize = function (dirtyAttrs) {
        ...
        var font = dirtyAttrs.font, size = dirtyAttrs.size, link = dirtyAttrs.link, script = dirtyAttrs.script, list = dirtyAttrs.list, header = dirtyAttrs.header, align = dirtyAttrs.align, direction = dirtyAttrs.direction, indent = dirtyAttrs.indent, tooltip = dirtyAttrs.tooltip, innerElement = dirtyAttrs.innerElement, emojiPickElement = dirtyAttrs.emojiPickElement, taskElement = dirtyAttrs.taskElement;
